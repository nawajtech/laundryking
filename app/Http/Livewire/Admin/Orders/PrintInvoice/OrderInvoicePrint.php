...
{
    public $order,$orderdetails, $logo, $orderaddons,$balance,$total,$delivery_charge,$customer,$outlet,$payments,$sitename,$address,$phone,$paid_amount,$payment_type,$zipcode,$tax_number,$store_email,$from_date,$to_date;
    /* render the page */
    ...
    public function mount($id)
    {
        ...
        $this->logo = asset('uploads/logo/laundrylogo.png');
