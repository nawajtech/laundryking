...
class Expenses extends Component
{
    ...
    public function update()
    {
        ...
        $this->editMode = false;
        $this->emit('closemodal');
        $this->dispatchBrowserEvent('alert', ['type' => 'success',  'message' => 'Expense Updated has been updated!']);
    }
    ...
    public function delete($id)
    {
        ...
        $this->dispatchBrowserEvent('alert', ['type' => 'success',  'message' => 'Expense deleted Successfully!']);
        if(Auth::user()->user_type==1)
        {
            $this->expenses = Expense::latest()->get();
        } else {
