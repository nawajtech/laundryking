"use strict";
! function () {
   var e, t; - 1 < navigator.platform.indexOf("Win") && (document.getElementsByClassName("main-content")[0] && (e = document.querySelector(".main-content"), new PerfectScrollbar(e)), document.getElementsByClassName("fixed-plugin")[0] && (t = document.querySelector(".fixed-plugin"), new PerfectScrollbar(t)))
...
function sidebarColor(e) {
   ...
   e.classList.contains("active") ? e.classList.remove("active") : e.classList.add("active"), document.querySelector(".sidenav").setAttribute("data-color", a), document.querySelector("#sidenavCard") && (e = ["btn", "btn-sm", "w-100", "mb-0", "bg-gradient-" + a], (a = document.querySelector("#sidenavCard .btn")).className = "", a.classList.add(...e))
}

function sidebarType(e) {
   for (var t = e.parentElement.children, a = e.getAttribute("data-class"), n = document.querySelector("body"), i = document.querySelector("body:not(.dark-version)"), n = n.classList.contains("dark-version"), l = [], s = 0; s < t.length; s++) t[s].classList.remove("active"), l.push(t[s].getAttribute("data-class"));
   ...
   "bg-white" == a && i ? (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && (c = o.replace("logo-ct", "logo-ct-dark"), r.src = c) : (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct-dark.png") && (c = o.replace("logo-ct-dark", "logo-ct"), r.src = c), "bg-white" == a && n && (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && (c = o.replace("logo-ct", "logo-ct-dark"), r.src = c)
}
...
function navbarBlurOnScroll(e) {
   ...
   let n = ["bg-white", "left-auto", "position-sticky"],
      i = ["shadow-none"];
...
function navbarColorOnResize() {
   try {
      sidenav && (1200 < window.innerWidth ? referenceButtons.classList.contains("active") && "bg-default" === referenceButtons.getAttribute("data-class") ? sidenav.classList.remove("bg-white") : sidenav.classList.add("bg-white") : (sidenav.classList.add("bg-white"), sidenav.classList.remove("bg-default")))
   } catch (err) {
...
function darkMode(e) {
   const t = document.getElementsByTagName("body")[0],
      ...
      x = w.src,
      L = document.querySelectorAll(".navbar-main .nav-link, .navbar-main .breadcrumb-item, .navbar-main .breadcrumb-item a, .navbar-main h6"),
   ...
   if (e.getAttribute("checked")) {
      t.classList.remove("dark-version"), n.classList.add("bg-white"), x.includes("logo-ct.png") && (q = x.replace("logo-ct", "logo-ct-dark"), w.src = q);
      for (C = 0; C < L.length; C++) L[C].classList.contains("text-dark") && (L[C].classList.add("text-white"), L[C].classList.remove("text-dark"));
      for (C = 0; C < S.length; C++) S[C].classList.contains("text-white") && (S[C].classList.remove("text-white"), S[C].classList.add("text-dark"));
      for (C = 0; C < k.length; C++) k[C].classList.contains("text-white") && k[C].classList.remove("text-white");
      for (C = 0; C < a.length; C++) a[C].classList.contains("light") && (a[C].classList.add("dark"), a[C].classList.remove("light"));
      for (C = 0; C < l.length; C++) l[C].classList.contains("light") && (l[C].classList.add("dark"), l[C].classList.remove("light"));
      for (C = 0; C < s.length; C++) s[C].classList.contains("text-white") && (s[C].classList.remove("text-white"), s[C].classList.add("text-dark"));
      for (C = 0; C < o.length; C++) !o[C].classList.contains("text-white") || o[C].closest(".sidenav") || o[C].closest(".card.bg-gradient-dark") || (o[C].classList.remove("text-white"), o[C].classList.add("text-dark"));
      for (C = 0; C < d.length; C++) d[C].classList.contains("text-white") && (d[C].classList.remove("text-white"), d[C].classList.add("text-dark"));
      for (C = 0; C < g.length; C++) g[C].classList.contains("text-white") && (g[C].classList.remove("text-white"), g[C].classList.remove("opacity-8"), g[C].classList.add("text-dark"));
      for (C = 0; C < v.length; C++) v[C].classList.contains("bg-gray-600") && (v[C].classList.remove("bg-gray-600"), v[C].classList.add("bg-gray-100"));
      for (C = 0; C < p.length; C++) p[C].hasAttribute("fill") && p[C].setAttribute("fill", "#252f40");
      for (C = 0; C < h.length; C++) h[C].closest(".card.bg-gradient-dark") || (h[C].classList.remove("text-white"), h[C].classList.add("text-dark"));
      for (C = 0; C < y.length; C++) y[C].classList.remove("border-dark");
      e.removeAttribute("checked")
   } else {
      var q;
      t.classList.add("dark-version"), x.includes("logo-ct-dark.png") && (q = x.replace("logo-ct-dark", "logo-ct"), w.src = q);
      for (var C = 0; C < S.length; C++) S[C].classList.contains("text-dark") && (S[C].classList.remove("text-dark"), S[C].classList.add("text-white"));
      for (var C = 0; C < k.length; C++) k[C].classList.contains("text-sm") && k[C].classList.add("text-white");
      for (var C = 0; C < a.length; C++) a[C].classList.contains("dark") && (a[C].classList.remove("dark"), a[C].classList.add("light"));
      for (var C = 0; C < l.length; C++) l[C].classList.contains("dark") && (l[C].classList.remove("dark"), l[C].classList.add("light"));
      for (var C = 0; C < s.length; C++) s[C].classList.contains("text-dark") && (s[C].classList.remove("text-dark"), s[C].classList.add("text-white"));
      for (var C = 0; C < r.length; C++) r[C].classList.contains("text-dark") && (r[C].classList.remove("text-dark"), r[C].classList.add("text-white"));
      for (var C = 0; C < c.length; C++) c[C].classList.contains("text-dark") && (c[C].classList.remove("text-dark"), c[C].classList.add("text-white"));
      for (var C = 0; C < u.length; C++) u[C].classList.contains("text-dark") && (u[C].classList.remove("text-dark"), u[C].classList.add("text-white"));
      for (var C = 0; C < g.length; C++) g[C].classList.contains("text-secondary") && (g[C].classList.remove("text-secondary"), g[C].classList.add("text-white"), g[C].classList.add("opacity-8"));
      for (var C = 0; C < m.length; C++) m[C].classList.contains("bg-gray-100") && (m[C].classList.remove("bg-gray-100"), m[C].classList.add("bg-gray-600"));
      ...
      for (var C = 0; C < p.length; C++) p[C].hasAttribute("fill") && p[C].setAttribute("fill", "#fff");
      for (var C = 0; C < b.length; C++) b[C].classList.add("border-dark");
...
var argon = {
   ...
   initVectorMap: function () {
      am4core.ready(function () {
         ...
         t.tooltipText = "{name}", t.polygon.fillOpacity = .6, t.states.create("hover").properties.fill = e.colors.getIndex(0);
