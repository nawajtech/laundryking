                        ...
                        <div class="card border-0 mb-0">
                            <div class="card-header bg-transparent text-center">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2 mb-2">
                                    ...
                                    <h4 class="text-dark ms-3 mb-0 text-uppercase" style="font-size: 1.5rem;">{{ getApplicationName() }}</h4>
                                </div>
                            </div>
                                    ...
                                    <form role="form" class="text-start">
                                        ...
                                        <div class="mb-2 position-relative text-center">
                                            <p class="text-sm fw-500 mb-2 text-secondary text-border d-inline z-index-2 bg-white px-3">
                                                Powered by <a href="https://notebrains.com/" class="text-dark fw-600" target="_blank">Notebrains</a>
                                            </p>
                                        </div>
                                        @if($forgetpassword == 1)
