<div>
    <div class="row align-items-center justify-content-between mb-4">
        <div class="col">
            <h5 class="fw-500 text-white">{{ $lang->data['edit_order'] ?? 'Edit Order' }} - {{ $order_id }}</h5>
        </div>
        <div class="col-auto">
    ...
    <div class="modal fade" id="addcustomer" tabindex="-1" role="dialog" aria-labelledby="addcustomer" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document" style="max-width:650px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title fw-600" id="addcustomer">{{ $lang->data['add_customer'] ?? 'Add Customer' }}</h6>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="modal-body">
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-md-3 mb-1">
                                ...
                                <input type="date" required class="form-control" wire:model="dob">
                                @error('dob')
                                    <span class="error text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-12 mb-1">
                                ...
                                <input type="text" required class="form-control" placeholder="{{ $lang->data['enter_phone_number'] ?? 'Enter Phone Number' }}" wire:model="customer_phone">
                            ...
                            <div class="col-md-6 mb-1">
                                <label class="form-label">{{ $lang->data['discount'] ?? 'Dicount' }} ( % ) </label>
                                <input type="text" required class="form-control" placeholder="{{ $lang->data['enter_discount'] ?? 'Enter Discount Percent' }}" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" wire:model="discnt">
                                @error('discnt')
                                    <span class="error text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="row g-2 align-items-center">
                            <div class=" col-12">
                                ...
                                <hr>
                                @php
                                    $received_amount = \App\Models\Payment::where('order_id', $order->id)->sum('received_amount')
                                @endphp
                                <div class="row ">
                                    <div class="col-md-4 mb-1 pr-0">
                                        <label class="form-label">{{ $lang->data['paid_amount'] ?? 'Paid Amount' }}</label>
                                        <input readonly  type="number" class="form-control" placeholder="{{ $lang->data['enter_amount'] ?? 'Enter Amount' }}" wire:model="paid_amount">
                                        <div class="col text-sm fw-600">{{ $lang->data['received_amount'] ?? 'Received Amount' }}:{{ getCurrency() }}
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ $lang->data['cancel'] ?? 'Cancel' }}</button>
                        <button type="submit" class="btn btn-primary" wire:click.prevent="storeAssignAddon({{ $addonKey }})">{{ $lang->data['save'] ?? 'Save' }}</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ $lang->data['cancel'] ?? 'Cancel' }}</button>
                        <button type="submit" class="btn btn-primary" wire:click.prevent="storeAssignBrand({{ $brandKey }})">{{ $lang->data['save'] ?? 'Save' }}</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <?php if($selected_customer){ ?>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <div class="text-xs">
                                <i class="fa fa-envelope me-2"></i> {{$selected_customer->email}}
                            </div>
                        </div>
                        <div class="col-auto">
                            <div class="text-xs">
                        ...
                        <div class="col-auto">
                            <div class="text-xs">
                                <i class="fa fa-birthday-cake me-2"></i> {{ date("d-M-Y", strtotime($selected_customer->dob)) }}
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <form>
                    <div class="modal-body">
                        <div class="row g-2 align-items-center">
                            <?php if($selected_customer && $orderhistory){?>
                                ...
                                @foreach ($orderhistory as $item)
                                    ...
                                    <tr @if($item->status == 10) style="background:rgb(255, 30, 30,.1);" @endif>
                                        ...
                                        <td class="px-3">
                                            ...
                                            <a target="_blank" href="{{ route('admin.view_single_order', $item->id) }}" type="button"
    ...
    <div class="modal fade" id="addpayment" tabindex="-1" role="dialog" aria-labelledby="addpayment" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title fw-600" id="addpayment">{{ $lang->data['payment_details'] ?? 'Payment Details' }}</h6>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
