...
<div class="row align-items-center justify-content-between mb-4">
    <div class="col">
        <h5 class="fw-500 text-white">{{$lang->data['outlet_report'] ?? 'Outlet Report'}}</h5>
    </div>
</div>
<div class="row">
    <div class="col-12">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-bordered align-items-center mb-0">
                        <thead class="bg-light">
                            <tr>
                                <th style="width: 40%" class="text-uppercase text-secondary text-xs opacity-7">{{$lang->data['outlet_name'] ?? 'Outlet Name'}}</th>
                                <th style="width: 30%" class="text-uppercase text-secondary text-xs  opacity-7">{{$lang->data['outlet_code'] ?? 'Outlet Code'}}</th>
                ...
                <div class="row align-items-center px-4 mb-3">
                    ...
                    <div class="col-auto">
                        ...
                        <a href="{{url('admin/reports/print-report/outlet/'.$from_date.'/'.$to_date.'/'.$outlet)}}" target="_blank">                  
